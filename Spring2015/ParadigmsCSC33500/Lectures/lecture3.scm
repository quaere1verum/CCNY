...
; why does (sqrt 5) work?  what if we changed the 1.0 to 1 in the call of sqrt-iter from sqrt?
...
; once all the pieces are working, you might wish to collect
...
; defined inside new-fact.  observe as well that the second form results in less cluttering
; of the global namespace. 


; now for a proof that the iterative version works as advertized
...
; practice: prove both versions correct
...
; homework exercises to be completed for Tuesday, February 10
...
; procedure in evaluating (+ 4 5).  Are the processes recursive or
; iterative?
