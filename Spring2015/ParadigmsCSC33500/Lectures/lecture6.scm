...
; begin by discussing some of the yet undiscussed examples shown in the files
; lecture4.scm and lecture5.scm

; conclude by looking at ideas from Section 1.3 of Abelson and Sussman, folded
; with our ongoing discussion of program proving
...
; generalize it.  In the course of doing so, we hope to shed some light on the
